...
export function RegisterPage() {
  ...
  const inputClass = "w-full pl-11 pr-4 py-3.5 rounded-xl border border-[#e8ddd5] bg-white text-[#3d2b1f] placeholder-[#c4b5a8] text-sm focus:outline-none focus:border-[#c8722a] focus:ring-2 focus:ring-[#c8722a]/20 transition-all";
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-5 py-10" style={{ backgroundColor: "#f5ede6" }}>
      <div className="w-full max-w-sm bg-white rounded-3xl shadow-xl shadow-[#c8722a]/10 p-8">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-black text-[#2d1e0f] tracking-tight leading-none" style={{ fontFamily: "'Georgia', serif" }}>
            Food Store
          </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-[10px] font-bold tracking-[0.15em] text-[#5a4a3a] uppercase mb-2">Nombre</label>
            ...
            <div>
              <label className="block text-[10px] font-bold tracking-[0.15em] text-[#5a4a3a] uppercase mb-2">Apellido</label>
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#b08060]">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" />
          ...
          {/* Email */}
          <div>
            <label className="block text-[10px] font-bold tracking-[0.15em] text-[#5a4a3a] uppercase mb-2">Email</label>
            <div className="relative">
              <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#b08060]">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          {/* Celular */}
          <div>
            <label className="block text-[10px] font-bold tracking-[0.15em] text-[#5a4a3a] uppercase mb-2">Celular <span className="font-normal text-[#9a8070]">(opcional)</span></label>
            <div className="relative">
              <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#b08060]">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <label className="block text-[10px] font-bold tracking-[0.15em] text-[#5a4a3a] uppercase">Contraseña</label>
              <button type="button"
            ...
            <div className="relative">
              ...
              <input name="password" type={showPass ? "text" : "password"} value={form.password} onChange={handleChange} placeholder="Mínimo 8 caracteres" required className="w-full pl-11 pr-11 py-3.5 rounded-xl border border-[#e8ddd5] bg-white text-[#3d2b1f] placeholder-[#c4b5a8] text-sm focus:outline-none focus:border-[#c8722a] focus:ring-2 focus:ring-[#c8722a]/20 transition-all" />
          ...
          {/* Confirmar */}
          <div>
            <label className="block text-[10px] font-bold tracking-[0.15em] text-[#5a4a3a] uppercase mb-2">Confirmar</label>
            <div className="relative">
              <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#b08060]">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <rect x="3" y="11" width="18" height="11" rx="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" />
          ...
          <button type="submit" disabled={loading}
            className="w-full bg-[#c8722a] hover:bg-[#a85e1f] active:bg-[#8f5019] disabled:opacity-60 disabled:cursor-not-allowed text-white font-bold text-xs tracking-[0.2em] uppercase py-4 rounded-xl transition-all duration-200 flex items-center justify-center gap-3 shadow-lg shadow-[#c8722a]/30">
            {loading ? (
              <>
        ...
        <button onClick={() => setHelpOpen(true)}
          ...
          <p className="text-xs text-[#9a8070]">Soporte&nbsp;•&nbsp;<span className="font-semibold text-[#5a4a3a]">Centro de Ayuda</span></p>
        ...
        <p className="text-center text-sm text-gray-500 mt-5">
          ¿Ya tenés cuenta?{" "}
          <Link to="/login" className="text-[#c8722a] font-semibold hover:underline">Iniciá sesión</Link>
        </p>
      </div>
